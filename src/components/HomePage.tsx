...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const portalCategories: PortalCategory[] = [
    ...
    },
    {
      ...
      title: "التعليم الصريح",
      targetTab: "explicit_teaching",
      icon: Presentation,
      iconColor: "text-amber-500",
      iconBg: "bg-amber-50",
      borderHover: "hover:border-amber-400",
      borderBottomColor: "border-b-amber-500",
      description: "عروض PPT للمسلاط، كراسات التلميذ، والسيناريوهات البيداغوجية لمؤسسات الريادة",
      badge: "الريادة",
      externalUrl: PROFPRESS_LINKS.explicitTeaching,
      content: {
        subtitle: "الحقيبة البيداغوجية الشاملة لدروس التعليم الصريح (Enseignement Explicite)",
        highlights: [
          "عروض تفاعلية بصيغة PPTX جاهزة للمسلاط الضوئي تغطي مستويات 1AEP إلى 6AEP.",
          "تطبيق المراحل الخمس: التهيئة، النمذجة (أنا أعمل)، الممارسة الموجهة (نحن نعمل)، الممارسة المستقلة، والتقويم الفوري.",
          "كراسات التلميذ المحينة ودلائل الأستاذ لجميع الوحدات الدراسية المعتمدة بمدارس الريادة.",
        ],
        tips: "استخدم عروض PPT التفاعلية لترسيخ الوعي الصوتي والطلاقة والحساب الذهني اليومي.",
        actionLabel: "فتح فضاء التعليم الصريح",
        targetTab: "explicit_teaching",
      },
    },
    {
    ...
    },
    {
      ...
      targetTab: "inspection_competition",
      icon: ShieldCheck,
      ...
      content: {
        subtitle: "المسار المهني لولوج سلك التفتيش والتأطير والمراقبة التربوية والتخطيط والمصالح المالية",
        highlights: [
          "توصيفات ومذكرات مباراة ولوج مركز تكوين مفتشي التعليم (CFIE) ومسلك التخطيط (COPE).",
          "المحاور الأربعة: المعارف الأكاديمية، الديداكتيك، علوم التربية، ونماذج الامتحانات المصححة.",
          "نماذج امتحانات سابقة مع عناصر الإجابة الرسمية وبنك أسئلة تفاعلي QCM قابل للتعديل.",
        ],
        tips: "استفد من الاختبارات التجريبية وبنك نماذج الامتحانات المصححة المتاحة في الصفحة المخصصة.",
        actionLabel: "فتح صفحة مباراة التفتيش",
        targetTab: "inspection_competition",
      },
    },
    {
      id: "orientation",
      title: "مباراة التوجيه والتخطيط",
      targetTab: "orientation_planning",
      icon: Compass,
      iconColor: "text-indigo-600",
      iconBg: "bg-indigo-50",
      borderHover: "hover:border-indigo-400",
      borderBottomColor: "border-b-indigo-600",
      description: "مركز التوجيه والتخطيط التربوي (COPE)، الحقيبة الشاملة والمحاور الأساسية",
      badge: "COPE",
      externalUrl: PROFPRESS_LINKS.orientation,
      content: {
        subtitle: "الفضاء الشامل لمباراة التوجيه والتخطيط التربوي (مركز COPE)",
        highlights: [
          "الحقيبة الشاملة (Google Drive) ونماذج الامتحانات السابقة مع التصحيح (2017 - 2024).",
          "المحاور الأساسية: التوجيه المدرسي والمهني، التخطيط التربوي، النظام التربوي، وسيكولوجيا التربية.",
          "روائز السيكوتقني، السياسات العمومية، وبنك أسئلة تفاعلي QCM لاجتياز المباراة بنجاح.",
        ],
        tips: "استفد من الحقيبة الشاملة ونماذج الاختبارات المصححة المتوفرة للتحميل المباشر.",
        actionLabel: "فتح صفحة التوجيه والتخطيط",
        targetTab: "orientation_planning",
      },
    },
    {
