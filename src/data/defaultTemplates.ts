...
export const DEFAULT_WORKSHOP_REPORT: WorkshopReportData = {
  title: "تقرير إجمالي وتنفيذي: أشغال اليوم الثالث",
  dayNumber: "اليوم الثالث",
  subtitle: "الورشات التذكيرية لدعم التعلمات الأساس بمؤسسات الريادة",
  ...
  technicalCard: {
    ...
    sessionNature: "ورشات تخصصية ومناقشة تطبيقية",
    axes: "الموضعة، المسارات، اللبنات/الفترات في المواد الثلاث",
    strategicObjective:
      "توحيد الممارسات الصفية والمفاهيم المعتمدة للانتقال المنظم للمتعلمين من مرحلة نتائج الموضعة إلى المسارات التعليمية المحددة، وفق بنية اللبنات والفترات المعتمدة برسم برنامج الدعم.",
  },
  generalIntro:
  ...
  mathActivities: [
    ...
    },
    {
      ...
      activities:
        "إضافة نشاط اعتيادي هندسي موجه للتدرب المنهجي على استعمال الأدوات الهندسية.",
    },
  ],
  mathLevels: [
    {
